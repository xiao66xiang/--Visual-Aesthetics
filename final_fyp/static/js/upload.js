  ...
  listen(resolve, reject) {
    this.fileInput.onchange = (e) => {
      ...
      if (!this.validFileType(file.type)) {
        ...
        document.querySelector('.filePhoto').style.zIndex = '0';
      }
    };
  }
...
class Cropper {
  ...
  drawCropWindow() {
    ...
    const radius = this.crop.handleSize ;
    ...
    var a = document.querySelector('.js-editorcanvas');
...
try {
    var uploader = new Uploader({
        input: document.querySelector('.filePhoto'),
        types: [ 'gif', 'jpg', 'jpeg', 'png' ]
    });
    ...
    document.getElementById('submitbutton').onclick = (e) => editor.export(img);
